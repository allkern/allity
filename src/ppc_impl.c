...
void ppc_addis(struct ppc_state* cpu) { puts("ppc: addis unimplemented"); exit(1); }
void ppc_addi(struct ppc_state* cpu) { puts("ppc: addi unimplemented"); exit(1); }
...
void ppc_bc(struct ppc_state* cpu) { puts("ppc: bc unimplemented"); exit(1); }
void ppc_b(struct ppc_state* cpu) { puts("ppc: b unimplemented"); exit(1); }
void ppc_bclr(struct ppc_state* cpu) { puts("ppc: bclr unimplemented"); exit(1); }
...
void ppc_cmpi(struct ppc_state* cpu) { puts("ppc: cmpi unimplemented"); exit(1); }
...
void ppc_ld(struct ppc_state* cpu) { puts("ppc: ld unimplemented"); exit(1); }
...
void ppc_lbz(struct ppc_state* cpu) { puts("ppc: lbz unimplemented"); exit(1); }
...
void ppc_mfspr(struct ppc_state* cpu) { puts("ppc: mfspr unimplemented"); exit(1); }
...
void ppc_ori(struct ppc_state* cpu) { puts("ppc: ori unimplemented"); exit(1); }
void ppc_oris(struct ppc_state* cpu) { puts("ppc: oris unimplemented"); exit(1); }
void ppc_or(struct ppc_state* cpu) { puts("ppc: or unimplemented"); exit(1); }
...
void ppc_rldicl(struct ppc_state* cpu) { puts("ppc: rldicl unimplemented"); exit(1); }
...
void ppc_std(struct ppc_state* cpu) { puts("ppc: std unimplemented"); exit(1); }
void ppc_stmw(struct ppc_state* cpu) { puts("ppc: stmw unimplemented"); exit(1); }
void ppc_stdu(struct ppc_state* cpu) { puts("ppc: stdu unimplemented"); exit(1); }
...
void ppc_stb(struct ppc_state* cpu) { puts("ppc: stb unimplemented"); exit(1); }
